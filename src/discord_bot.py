...
async def due_in(ctx, *, course):
    ...
    if assignments:
        ...
        for assignment in assignments:
            ...
            # Access 'due date' and 'start date'
            if 'due date' in assignment:
                due_date_str = assignment['due date']['start']
                try:
                    # Parse the ISO format date and format it as "day month year"
...
async def remaining(ctx):
    ...
    if assignments:
        ...
        for assignment in assignments:
            ...
            # start_date = format_date(assignment['start date']['start']) if 'start date' in assignment else "No start date available"
